    ...
    <div className="flex">
      ...
      <div className="bg-gray-800 text-white w-64 py-6 px-8">
        ...
        <ul className="mt-6">
          ...
          <li>
            <Link to="/staff/query" className="text-blue-500 hover:text-blue-400">Query</Link>
          </li>
          <li>
            <Link to="/staff/dashboard/attendance" className="text-blue-500 hover:text-blue-400">Attendance Record</Link>
          </li>
        </ul>
      </div>
      {/* Content */}
